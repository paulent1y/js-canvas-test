...
const TILES_AMOUNT = 20; // количество ячеек на поле (по каждой из координат)
const FIELD_COLOR = randomColor();
const TILE_COLOR_N = randomColor();
const COLOR_P1 = 0;
const COLOR_P2 = 0;
...
function drawGameField() {
    ...
    //задаем сторону игрового поля по меньшей стороне
    if (wx<wy)
    ...
    */
    let tileSize = Math.ceil((fieldSide / TILES_AMOUNT) * 95)/100;
